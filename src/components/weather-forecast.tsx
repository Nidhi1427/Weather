...
const WeatherForecast = ({ data }: WeatherForecastProps) => {
  ...
  return (
    <Card>
      ...
      <CardContent style={{padding: '24px'}} className="backdrop-blur-xl bg-white/10 border-white/20 shadow-2xl"
>
        <div className="grid gap-4">
          {nextDays.map((day) => (
            <div
              key={day.date}
              className="grid grid-cols-3 items-center gap-4 rounded-lg border p-6 !p-6"
              style={{ padding: '24px' }}
            >
              <div>
